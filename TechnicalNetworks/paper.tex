...
research in this area is based off identifying
...
~\cite{Kim:2006:AIB}. 
This module related method also results in predictions 
...
% Call Graph
A method call graph is constructed to extract method call hierarchies in a project at a given code change. 
...
\section{Results}
The Hibernate-ORM project which is an open source Java 
application hosted on GitHub\footnote{https://github.com/}, was chosen for study. The issue tracking for this 
